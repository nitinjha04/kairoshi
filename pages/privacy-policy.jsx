...
const PrivacyPolicy = () => {
  return (
    <Layout title="Privacy Policy" description="Privacy Policy of Kairoshi">
      <section className="mx-auto max-w-7xl py-8 px-4">
        ...
        <ul className="list-disc pl-6">
          ...
          <li>
            ...
            “Us” or “Our” in this Agreement) refers to Kairoshi IO, Unated
          ...
          <li>
            <strong>Website</strong> refers to Kairoshi, accessible from{" "}
            <Link href="/">
              <a className="underline hover:text-blue-500">Kairoshi</a>
            </Link>
          </li>
          <li>
