...
const App = ({ Component, pageProps, router }) => {
  const url = `https://kairoshi.vercel.app/${router.route}`;
      ...
      <AuthProvider>
        ...
        <DefaultSeo
          ...
          openGraph={{
            ...
            url,
            description:
              "Kairoshi is an online web tool to help you with downloading Instagram Photos, Videos and IGTV videos. Kairoshi is designed to be easy to use on any device, such as, mobile, tablet or computer.",
            site_name: "Kairoshi | Home",
            images: [
              {
