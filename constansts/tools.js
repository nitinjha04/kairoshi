...
export const toolsData = [
  {
    ...
    icon: <ImageIcon />,
    description:
      "Instagram photo downloader provided by Kairoshi is a great tool for saving images from Instagram posts. With Kairoshi you can download a single posts image as well as download multiple Instagram photos.",
    underDev: false,
...

  {
    ...
    icon: <PlayIcon />,
    description:
      "REEL is a new video format that clone the principle of TikTok. Download Instagram REEL videos with help of Kairoshi. Our REEL downloader can help you to save your favorite Reels videos.",
    underDev: false,
  ...
  },
  {
    ...
    icon: <VideoIcon />,
    description:
      "Kairoshi is created to enable you to download IG videos for any purpose you want. Kairoshi supports video downloading for singular video and multiple video from carousels.",
    underDev: false,
